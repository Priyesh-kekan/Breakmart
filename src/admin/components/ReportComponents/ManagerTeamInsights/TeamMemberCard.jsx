...
const TeamMemberCard = ({ name, activityPercentage = 10 }) => {
  return (
    <div className="bg-white shadow-md rounded-lg p-4 w-full max-w-sm">
      ...
      <div className="flex justify-between text-sm text-gray-500 mt-2 px-4">
        <p className="text-green-600">20 Present</p>
        <p className="text-blue-600">10 Absent</p>
      </div>
      
      {/* Progress Bar */}
      <div className="relative w-full bg-gray-300 rounded-full h-6 mt-2 overflow-hidden z-4">
        <div
